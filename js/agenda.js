function CalendarApp(date) {
  ...
  this.quotes = [
    "Trata-se de uma instância paritária de articulação de políticas públicas voltadas para a erradicação do trabalho escravo, sendo composta por representantes de órgãos governamentais, do Poder Judiciário e da sociedade civil organizada.",
    "As ações de comunicação buscam pensar estratégias para potencializar a visibilidade do assunto na sociedade.",
    "As ações de reinserção tratam do atendimento direto às vítimas e sobreviventes do trabalho escravo, possuindo assim uma destacada centralidade na garantia dos direitos humanos.",
    "As ações gerais englobam todo tipo de providências não específicas.",
  ];
  this.apts = [
    {
  ...
  this.todayIsSpan.textContent =
    "Hoje é " + date.getDate() + " " + this.months[date.getMonth()];
}
